...
public sealed class FileMetadataSnapshotWriter(IMongoContext mongoContext)
    : IFileMetadataSnapshotWriter
{
    ...
    {
        var document = new FileMetadataSnapshotDocument
        {
        ...
        return mongoContext
            .GetCollection<FileMetadataSnapshotDocument>()
